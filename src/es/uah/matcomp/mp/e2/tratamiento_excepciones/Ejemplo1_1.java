...
public class Ejemplo1_1 {
    ...
    // Para todos los ejemplos de esta práctica, el metodo main del proyecto llama a run() para ejecutar cada ejemplo por separado,
    // de manera que evito que cada ejemplo tenga su propio main

    public static void run() {
        System.out.println("Ejemplo 1.1 — Scanner con try-catch");

        try { //Intenta abrir el archivo, en caso de que no exista se ejecuta al catch
